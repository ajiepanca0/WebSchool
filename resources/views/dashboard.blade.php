...
<head>
    ...
    <link href="admin/assets/vendor/fontawesome-free/css/all.min.cssadmin/assets/ rel="stylesheet" type="text/css">
    <link
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Kritik / Saran</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$kritik}}</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Kode Terpakai
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$kodeterpakai}}</div>
                                                </div>
                                                <div class="col">
